...
var noestanvacios=false;//bandera
var nombrevalido=false;//bandera
var notasvalidas=false;//bandera
var notadesafio1=false;//bandera
var notadesafio2=false;//bandera
var notadesafio3=false;//bandera
var notadesafio4=false;//bandera
var notaexamen=false;//bandera
...
function nombre_valido(id){
	...
	if (isNaN(input.value) || input.value=="" ) {  // si no es un numero o esta vacio
		...
		return nombrevalido=true;//bandera
	}else{ 
...
function notas_validas(nota,mensaje){
	...
	if (nota.value<0 ||nota.value>100) {
		...
		return notasvalidas=false; //bandera
	}else{
		nota.style.backgroundColor="white";
		alertadesafio.style.visibility="hidden"
		if (nota.name=="desafio1") { 
		notadesafio1=true;} //bandera
		if (nota.name=="desafio2") { 
		notadesafio2=true;} //bandera
		if (nota.name=="desafio3") { 
		notadesafio3=true;} //bandera
		if (nota.name=="desafio4") { 
		notadesafio4=true;} //bandera
		if (nota.name=="examen") { 
		notaexamen=true;} //bandera
		
		if (notadesafio1==true && notadesafio2==true && notadesafio3==true && notadesafio4==true && notaexamen==true){
			return notasvalidas=true;//bandera
		}	
...
function procesar(){
	if (noestanvacios==true && nombrevalido==true && notasvalidas==true){
